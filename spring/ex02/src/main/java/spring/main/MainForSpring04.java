...
public class MainForSpring04 {

	static Scanner scan = new Scanner(System.in);
	private static ApplicationContext ctx = null;

	public static void main(String[] args) {
		ctx = new GenericXmlApplicationContext("classpath:appCtx04.xml");// 스프링 설정파일 읽어오기
		...
		while(true) {
			...
			else if(selectMenu.equals("4")) {// 특정회원 정보보기
				processInfoCommand();         
			}
			else if(selectMenu.equals("5")) {// 특정회원 정보보기
	...
	private static void processInfoCommand() {
		...
		System.out.println("조회하고자 하는 계정을 입력하세요");
	...
	private static void menu() {
		...
		System.out.println("4.특정회원정보보기");
		System.out.println("5.프로그램버전보기");
