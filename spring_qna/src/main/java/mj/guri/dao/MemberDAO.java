...
//	}
	...
	public List<MemberVO> selectAll() {
		...
		List<MemberVO> list = sqlSession.selectList("mybatis.mapper.member.selectAll");
		return list;
	}
	...
	public MemberVO selectById(String memberId) {
		...
		MemberVO result = sqlSession.selectOne("mybatis.mapper.member.selectById", memberId);
		return result;
	}
	...
	public MemberVO selectByNum(Long memberNum) {
		...
		MemberVO result = sqlSession.selectOne("mybatis.mapper.member.selectByNum", memberNum);
		return result;
	}
...
//		reg.getMemberPhone());
	...
	public void updateMember(MemberVO mVo) {
		...
		sqlSession.update("mybatis.mapper.member.updateMember", mVo);
//		mVo.getMemberId(),
//		mVo.getMemberName(),
//		mVo.getMemberEmail(),
//		mVo.getMemberPhone(),
